...
import 'features/charts/domain/usecases/get_charts_configuration_use_case.dart';
import 'features/charts/domain/usecases/get_charts_data_use_case.dart';
import 'features/charts/domain/usecases/get_charts_layout_use_case.dart';
import 'features/charts/domain/usecases/save_charts_configuration_use_case.dart';
...
Future<void> init() async {
  ...
  getIt.registerFactory(
          () => ChartsBloc(
              ...
              saveChartsLayout: getIt(),
              getChartsLayout: getIt(),
              saveConfiguration: getIt(),
              getConfiguration: getIt(),
          ));
  ...
  getIt.registerLazySingleton(() => SaveChartsLayoutUseCase(getIt()));
  getIt.registerLazySingleton(() => GetChartsLayoutUseCase(getIt()));
  getIt.registerLazySingleton(() => SaveChartsConfigurationUseCase(getIt()));
  getIt.registerLazySingleton(() => GetChartsConfigurationUseCase(getIt()));
